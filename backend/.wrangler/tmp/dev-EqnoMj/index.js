...
app6.route("/api/categories", categories_default);
app6.route("/api/transactions", transactions_default);
app6.route("/api/budgets", budgets_default);
app6.route("/api/reports", reports_default);
app6.route("/api/voice", voice_default);
app6.notFound((c) => {
