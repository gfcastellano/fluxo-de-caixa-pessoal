export const enTranslations = {
  ...
  settings: {
    ...
    family: {
      title: 'Family',
      description: 'Share your finances with family members',
      createFamily: 'Create Family',
      familyName: 'Family Name',
      familyNamePlaceholder: 'e.g., The Smiths',
      createDescription: 'You will be the owner of this family. You can invite other members after creating it.',
      noFamily: "You're not part of any family yet",
      noFamilyDescription: 'Create a family to start sharing your finances',
      ...
      inviteEmailPlaceholder: 'person@email.com',
      inviteDescription: 'Invite someone to join "{{familyName}}". Choose what data you want to share.',
      ...
      removeMemberConfirmDescription: 'Are you sure you want to remove this member from the family?',
      leaveFamily: 'Leave Family',
      leaveConfirmTitle: 'Leave this family?',
      leaveConfirmDescription: 'You will lose access to shared data and will no longer appear in family reports.',
      deleteFamily: 'Delete Family',
      deleteConfirmTitle: 'Delete this family?',
      deleteConfirmDescription: 'This will remove all members and shared data. This action cannot be undone.',
      permissionsTitle: 'What do you want to share?',
      editPermissions: 'Edit Permissions',
      sharing: {
        editTitle: 'Edit Sharing Permissions',
        editDescription: 'Control what data you share with {{name}}.',
        accounts: 'Accounts',
        creditCards: 'Credit Cards',
        budgets: 'Budgets',
        reports: 'Reports',
        ...
        showBillTotal: 'Show bill total',
        showSpent: 'Show spent',
        showRemaining: 'Show remaining',
        shareOverview: 'Share overview',
        shareCategoryBreakdown: 'Category breakdown',
        shareTrends: 'Trends',
        presetAll: '✅ Share Everything',
        presetBalances: '💰 Balances Only',
        presetNone: '🔒 Share Nothing',
      },
      toggle: {
        personal: 'Personal',
        family: 'Family',
      ...
      shared: {
        ...
        creditCards: 'Family Cards',
        budgets: 'Family Budgets',
        ownedBy: 'by {{name}}',
        noSharedData: 'No shared data yet',
        noSharedDataDescription: 'Family members\' shared data will appear here',
      },
    },
    legal: {
